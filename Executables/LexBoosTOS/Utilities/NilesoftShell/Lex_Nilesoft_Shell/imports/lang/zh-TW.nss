...
add_to_path="新增至 PATH"
path_user="使用者 PATH (HKCU)"
path_system="系統 PATH (HKLM, 管理員)"
attributes="屬性"
...
// terminal.nss
command_prompt_admin="命令提示字元 (Admin)"
windows_powershell_admin="Windows PowerShell (Admin)"
windows_terminal_admin="Windows Terminal (Admin)"
powershell_script="PowerShell 指令碼"
run_with_powershell="使用 PowerShell 執行"
run_with_powershell_admin="使用 PowerShell 執行 (Admin)"
batch_script="批次指令碼"
run_batch="執行"
run_batch_admin="執行 (Admin)"
