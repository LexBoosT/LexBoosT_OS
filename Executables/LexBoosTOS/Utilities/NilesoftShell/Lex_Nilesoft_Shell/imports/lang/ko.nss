...
path_user="사용자 PATH (HKCU)"
path_system="시스템 PATH (HKLM, 관리자)"
attributes="속성"
...
// terminal.nss
command_prompt_admin="명령 프롬프트 (Admin)"
windows_powershell_admin="Windows PowerShell (Admin)"
windows_terminal_admin="Windows Terminal (Admin)"
powershell_script="PowerShell 스크립트"
run_with_powershell="PowerShell로 실행"
run_with_powershell_admin="PowerShell로 실행 (Admin)"
batch_script="배치 스크립트"
run_batch="실행"
run_batch_admin="실행 (Admin)"
