...
add_to_path="添加到 PATH"
path_user="用户 PATH (HKCU)"
path_system="系统 PATH (HKLM, 管理员)"
attributes="属性"
...
// terminal.nss
command_prompt_admin="命令提示符 (Admin)"
windows_powershell_admin="Windows PowerShell (Admin)"
windows_terminal_admin="Windows Terminal (Admin)"
powershell_script="PowerShell 脚本"
run_with_powershell="使用 PowerShell 运行"
run_with_powershell_admin="使用 PowerShell 运行 (Admin)"
batch_script="批处理脚本"
run_batch="运行"
run_batch_admin="运行 (Admin)"
