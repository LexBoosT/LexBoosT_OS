...
-----
## LexBoosT OS™ 26.09.1 — Documentation française
...
| :-: | :-: | :-: | :-: |
|**Processus en idle**|~180-220|~45-65|**-68%**|
|**RAM idle (16 GB)**|~4.5-5.5 GB|~1.8-2.5 GB|**-50%**|
|**Services exécutés**|~120-150|~40-60|**-60%**|
|**Latence DPC**|300-800 µs|40-120 µs|**-75%**|
|**Temps de boot**|25-40 sec|10-18 sec|**-55%**|
|**FPS moyen (gaming)**|Baseline|+12-22%|**+17%**|
|**Perf CPU (Spectre off)**|Baseline|+7-17%|**+12%**|
|**Latence input (gaming)**|25-40 ms|8-18 ms|**-55%**|
|**Télémétrie sortante**|~250 req/h|0|**-100%**|
|**Applications inutiles**|30+|0|**-100%**|
|**Tweaks DWM (clés)**|0|**124**|—|
|**Tweaks Timer (clés)**|0|**43**|—|
|**Tweaks USB (clés)**|0|**30**|—|
|**Tweaks GPU NVIDIA (boutons)**|0|**30**|—|
|**Tweaks GPU AMD (boutons)**|0|**19**|—|
|**Services configurés**|~120-150|**245**|—|
|**Tâches planifiées désactivées**|0|**~210**|—|
|**Outils post-install (Launcher)**|0|**40+**|—|
...
- **Kernel** : MMCSS recalibré (NetworkThrottlingIndex=ffffffff, NoLazyMode), TSX activé, ThreadDpcEnable, watchdogs kernel restaurés aux valeurs par défaut
...
- **Mémoire** : DisablePagingExecutive (noyau en RAM), Memory Compression désactivée si 16 GB+, CFG activé, SysMain en Automatique (prefetch désactivé — choix volontaire)
- **Boot** : BCD tweaks (disabledynamictick — Intel, isolatedcontext/nx — non-AMD, bootmenupolicy Legacy), NTFS optimisé (disableLastAccess, 8dot3, MFT zone), ServicesPipeTimeout=30s
- etc...
...
- **PerfTrack, SleepStudy, DOTNET\_CLI\_TELEMETRY, POWERSHELL\_TELEMETRY** : tous désactivés
...
- **Compatibilité** : SysMain=Automatic, ClipSVC=Auto (Win+V), TokenBroker=Auto (MS Store)
- etc...
#### 🎨 UX & Personnalisation
...
### 📥 Installation
1. **Prérequis** :
   1. Windows 11 propre (builds 26100 à 28000 supportées)
   1. Pilotes système à jour
   1. Mettez à jour les applications du Microsoft Store
   1. Vérifiez que les Widgets sont connectés à votre compte Microsoft
   1. **Faites un point de restauration système** (précaution)
   1. Redémarrez
1. **Lancez le Playbook**
1. **Suivez les options** : choisissez le navigateur, les packages à supprimer, le thème
1. **Redémarrez** une fois l'installation terminée

**Compatibilité matérielle** : AMD Ryzen / Intel Core 8+ gén, 8 GB RAM minimum (16 GB recommandé), SSD/NVMe recommandé.

-----
## LexBoosT OS™ 26.09.1 — English Documentation
...
| :-: | :-: | :-: | :-: |
|**Idle processes**|~180-220|~45-65|**-68%**|
|**Idle RAM (16 GB)**|~4.5-5.5 GB|~1.8-2.5 GB|**-50%**|
|**Running services**|~120-150|~40-60|**-60%**|
|**DPC latency**|300-800 µs|40-120 µs|**-75%**|
|**Boot time**|25-40 sec|10-18 sec|**-55%**|
|**Avg FPS (gaming)**|Baseline|+12-22%|**+17%**|
|**CPU perf (Spectre off)**|Baseline|+7-17%|**+12%**|
|**Input latency (gaming)**|25-40 ms|8-18 ms|**-55%**|
|**Outgoing telemetry**|~250 req/h|0|**-100%**|
|**Bloatware apps**|30+|0|**-100%**|
|**DWM tweaks (keys)**|0|**124**|—|
|**Timer tweaks (keys)**|0|**43**|—|
|**USB tweaks (keys)**|0|**30**|—|
|**GPU NVIDIA tweaks (buttons)**|0|**30**|—|
|**GPU AMD tweaks (buttons)**|0|**19**|—|
|**Configured services**|~120-150|**245**|—|
|**Disabled scheduled tasks**|0|**~210**|—|
|**Post-install tools (Launcher)**|0|**40+**|—|
...
- **Kernel**: MMCSS recalibrated (NetworkThrottlingIndex=ffffffff, NoLazyMode), TSX enabled, ThreadDpcEnable, kernel DPC watchdogs restored to defaults
...
- **Memory**: DisablePagingExecutive (kernel in RAM), Memory Compression disabled if 16 GB+, CFG enabled, SysMain Automatic (prefetch off - deliberate)
- **Boot**: BCD tweaks (disabledynamictick - Intel, isolatedcontext/nx - non-AMD, bootmenupolicy Legacy), NTFS optimized (disableLastAccess, 8dot3, MFT zone), ServicesPipeTimeout=30s
- etc...
...
- **PerfTrack, SleepStudy, DOTNET\_CLI\_TELEMETRY, POWERSHELL\_TELEMETRY**: all disabled
...
- **Compatibility**: SysMain=Automatic, ClipSVC=Auto (Win+V), TokenBroker=Auto (MS Store)
- etc...
#### 🎨 UX & Customization
...
### 📥 Installation
1. **Requirements**:
   1. Clean Windows 11 (builds 26100 to 28000 supported)
   1. Updated system drivers
   1. Update Microsoft Store apps
   1. Verify widgets are connected to your Microsoft account
   1. **Create a system restore point** (precaution)
   1. Reboot
1. **Launch the Playbook**
1. **Follow the options**: choose your browser, packages to remove, theme preferences
1. **Reboot** once installation is complete
